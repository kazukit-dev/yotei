...
export const UnderlinedInput = ({ className, ...props }: AriaInputProps) => {
  return (
    <AriaInput
      className={composeRenderProps(className, (className) => {
        return cn(
          "w-full border-b border-gray-300 focus:border-black outline-none px-1 pt-3 pb-1 transition duration-200",
